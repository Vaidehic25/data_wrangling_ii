...
but above not tidy dataset, each of the columns encoded as character bc
there is a, 12+ is age next to year
...
but how to get specific info we want? ahve to pull out elements fo html
that i care about
...
remember everythign you click knit it will import the data everytime
from internet so it will be clunk. better to just save the data
...
<img src="reading_data_web_files/figure-gfm/unnamed-chunk-7-1.png" width="90%" />

access BRFSS doesnt woks the same way as above. you need an app token by
creating account
...
Look at pokemon data. would have to do a lot of work to organize the
pokemon data looking at first one
